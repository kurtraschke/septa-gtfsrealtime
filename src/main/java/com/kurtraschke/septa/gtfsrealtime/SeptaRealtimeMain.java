...
public class SeptaRealtimeMain {

  private static final Logger _log = LoggerFactory.getLogger(SeptaRealtimeMain.class);
  ...
  private SeptaRealtimeProvider _provider;
  ...
  @Inject
  public void setProvider(SeptaRealtimeProvider provider) {
    _provider = provider;
  }
